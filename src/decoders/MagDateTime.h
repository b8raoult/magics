...
public:
    ...
    MagDate(const MagDate& other) : julian_(other.julian_) {}
    ...
    bool operator==(const MagDate& other) const { return julian_ == other.julian_; }
...
private:
    ...
    friend long operator-(const MagDate& d1, const MagDate& d2) { return (d1.julian_ - d2.julian_); }

    //	friend long operator-(const MagDate& d1)
    //		{ NOTIMP; return 0; }

    friend MagDate operator+(const MagDate& d1, const long n) { return MagDate::julianToMagDate(d1.julian_ + n); }

    friend MagDate operator+(const long n, const MagDate& d1) { return d1 + n; }
...
public:
    ...
    bool operator==(const MagTime& other) const { return seconds_ == other.seconds_; }
    ...
    Second operator-(const MagTime& other) const { return seconds_ - other.seconds_; }
