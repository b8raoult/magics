...
public:
    ...
    void set(const PaperPoint& point, BasicGraphicsObjectContainer& task) {
        ...
        l1->setThickness(1);
        l1->setLineStyle(LineStyle::M_DOT);
        ...
        l2->setThickness(1);
        l2->setLineStyle(LineStyle::M_DOT);
        ...
        lt->setThickness(1);
        lt->setLineStyle(LineStyle::M_DOT);
        ...
        lb->setThickness(1);
        lb->setLineStyle(LineStyle::M_DOT);
        ...
        task.push_back(lb);
        if (efi_ > -200) {
            if (magCompare(type_, "both") || (efi_ < 0 && magCompare(type_, "negative")) ||
