...
public:
    ...
    virtual void set(const XmlNode&) { MagLog::dev() << "HiLoMarkerBase::set(const XmlNode&)---> to be checked!...\n"; }
...
public:
    HiLoMarkerBase* operator()(const string& val) { return SimpleObjectMaker<HiLoMarkerBase>::create(val); }
