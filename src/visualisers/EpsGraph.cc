...
public:
    ...
    void set(const PaperPoint& point, BasicGraphicsObjectContainer& visitor) {
        ...
        max->setText("max");
        max->setFont(font_);
        max->setJustification(Justification::MLEFT);
        ...
        min->setText("min");
        min->setFont(font_);
        min->setJustification(Justification::MLEFT);
        ...
        seventyfive->setJustification(Justification::MLEFT);
        ...
        fifty->setFont(font_);
        fifty->setJustification(Justification::MLEFT);
        ...
        twentyfive->setJustification(Justification::MLEFT);
...
public:
    ...
    virtual void set(const PaperPoint& point, BasicGraphicsObjectContainer& visitor) {
        ...
        ninety->setJustification(Justification::MLEFT);
        ...
        ten->setText("10%");
        ten->setFont(font_);
        ten->setJustification(Justification::MLEFT);
...
public:
    ...
    void set(const PaperPoint& point, BasicGraphicsObjectContainer& visitor) {
        ...
        line->setLineStyle(LineStyle::M_SOLID);
        line->setThickness(2);
...
void EpsWind::operator()(Data& data, BasicGraphicsObjectContainer& visitor) {
    ...
    for (const auto& point : points) {
        ...
        grid->setThickness(2);
        grid->setLineStyle(LineStyle::M_DOT);
...
void EpsWave::operator()(Data& data, BasicGraphicsObjectContainer& visitor) {
    ...
    for (const auto& point : points) {
        ...
        if (point->find("control") != point->end()) {
            ...
            control->setLineStyle(LineStyle::M_DASH);
        ...
        if (point->find("hres") != point->end()) {
            ...
            hres->setThickness(2);
            hres->setLineStyle(LineStyle::M_SOLID);
...
public:
    ...
    void set(const PaperPoint& point, BasicGraphicsObjectContainer& visitor) {
        ...
        median->setLineStyle(LineStyle::M_SOLID);
        ...
        top->setLineStyle(LineStyle::M_DASH);
        top->setThickness(2);
        ...
        bottom->setLineStyle(LineStyle::M_DASH);
        ...
        text99->setJustification(Justification::MLEFT);
        ...
        text90->setJustification(Justification::MLEFT);
        ...
        text75->setJustification(Justification::MLEFT);
        ...
        text50->setJustification(Justification::MLEFT);
        ...
        text25->setJustification(Justification::MLEFT);
        ...
        text10->setJustification(Justification::MLEFT);
        ...
        text1->setJustification(Justification::MLEFT);
    ...
    for (const auto& point : points) {
        ...
        for (int i = 1; i <= (*point)["steps"]; i++) {
            ...
            if (available) {
                ...
                value->setJustification(Justification::MLEFT);
                value->setFont(font);
