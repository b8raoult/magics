...
public:
    ...
    virtual void set(const XmlNode&) { MagLog::dev() << "ValuePlotBase::set(const XmlNode&)---> to be checked!...\n"; }
...
public:
    ValuePlotBase* operator()(const string& val) { return SimpleObjectMaker<ValuePlotBase>::create(val); }
