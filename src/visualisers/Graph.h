...
public:
    ...
    void legend(bool legend, const string& text) {
        legend_      = legend;
        legend_text_ = text;
    }
...
protected:
    ...
    virtual void print(ostream& s) const  { s << "Graph[]"; }
    string legend_text_;
    bool legend_;
...
public:
    Graph* operator()(const string& val) { return SimpleObjectMaker<Graph>::create(val); }
