...
protected:
    ...
    virtual void print(ostream& s) const  { s << "PolyShadingMethod[]"; }
...
public:
    PolyShadingMethod* operator()(const string& val) { return SimpleObjectMaker<PolyShadingMethod>::create(val); }
