...
/*! \file AutomaticContourMethod.cc
    \brief
...
AutomaticContourMethod::AutomaticContourMethod() {}

AutomaticContourMethod::~AutomaticContourMethod() {}

ContourMethod* AutomaticContourMethod::clone() {
    return new AutomaticContourMethod();
}

bool AutomaticContourMethod::accept(const string& node) {
    return magCompare(node, "automatic");
}

MatrixHandler* AutomaticContourMethod::handler(const AbstractMatrix& matrix,
                                               const BasicGraphicsObjectContainer& owner) {
...
void AutomaticContourMethod::print(ostream& out) const {
