...
TephigramAttributes::TephigramAttributes():
...
void TephigramAttributes::set(const std::map<string, string>& params)
{
...
void TephigramAttributes::copy(const TephigramAttributes& other)
{
	x_min_ = other.x_min_;
...
bool TephigramAttributes::accept(const string& node)
{

	if ( magCompare(node, "tephigram")  )
		return true;
	
	return false;
}

void TephigramAttributes::set(const XmlNode& node)
{
	bool apply = false;
	...
	if ( magCompare(node.name(), "tephigram")  )
		apply = true;
...
void TephigramAttributes::print(ostream& out)  const
{
	out << "Attributes[";
	out << " x_min = " <<  x_min_;
...
void TephigramAttributes::toxml(ostream& out)  const
{
	out <<  "\"tephigram\"";
	out << ", \"x_min\":";
