...
public:
    ...
    virtual void set(const XmlNode& node) { MagnifierVisitorAttributes::set(node); }
    virtual void set(const map<string, string>& map) { MagnifierVisitorAttributes::set(map); }
