...
BasicSceneNode* MagMLLayoutManager::operator()(BasicSceneNode* parent, BasicPositionalObject* node) {
    ...
    if (actions_.empty()) {
        actions_[DisplayType::M_DT_INLINE]   = &MagMLLayoutManager::inline_display;
        actions_[DisplayType::M_DT_ABSOLUTE] = &MagMLLayoutManager::absolute;
        actions_[DisplayType::M_DT_BLOCK]    = &MagMLLayoutManager::block;
    }
