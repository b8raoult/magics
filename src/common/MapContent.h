...
#ifndef magics_MapContent_h
#define magics_MapContent_h
...
protected:
    ...
    virtual int compareMap(const MapContent&) const override;
    ...
    virtual std::string typeName() const override { return "Map"; }
