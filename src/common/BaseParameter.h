...
public:
    ...
    string getType(LineStyle) const;
    string getType(AxisAutomaticSetting) const;
    string getType(Justification) const;
    string getType(ArrowPosition) const;
